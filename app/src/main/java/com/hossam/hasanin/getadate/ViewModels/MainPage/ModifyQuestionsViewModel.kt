...
class ModifyQuestionsViewModel : ViewModel() {
    ...
    fun saveTheQuestion(question: UserCharacteristicQuestion , action : () -> Unit){
    ...
    fun deleteTheQuestion(id: String , action: () -> Unit){
        firestore.collection("users").document(mAuth.currentUser!!.uid)
